...
import { addTransaction, resetError, resetSuccess } from "../../../store/actions/transActions";
...
const TransactionAdd = ({ open, onClose, createdAt }) => {
  ...
  useEffect(() => {
    setFormData((formData) => ({ ...formData, createdAt: createdAt }));
  }, [createdAt]);
  ...
  return (
    <Dialog fullWidth open={open} maxWidth="sm" onClose={loading ? () => {} : handleClose}>
