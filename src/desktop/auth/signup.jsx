...
const Signup = () => {
  ...
  const { error, user, otpSuccess, success, loading, isAuthenticated } = useSelector(
  ...
  }, [isAuthenticated, otpSuccess, navigate]);
  ...
  return (
    <>
      ...
      <Wrapper>
        <OtpForm handleClose={handleOtpClose} open={otpOpen} />
                ...
                <Form>
                  ...
                  <Box mt={3}>
                    <Field
                      ...
                      label={t("auth.confirm-pass")}
                      placeholder="6+ characters password"
                      error={Boolean(touched.passwordConfirm && errors.passwordConfirm)}
                      helperText={
                        touched.passwordConfirm &&
                        errors.passwordConfirm &&
                        t(`auth.confirm-${errors.passwordConfirm}`)
                      }
                    />
                  </Box>
                  {error && (
                  ...
                  >
                    {t("auth.signup-footer-title")}{" "}
                    <Link sx={{ textDecoration: "none" }} to="/login" component={RouterLink}>
                      {t("auth.login")}
                    </Link>
                  </Typography>
                </Form>
